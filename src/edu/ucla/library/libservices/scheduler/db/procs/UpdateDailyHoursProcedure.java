...
public class UpdateDailyHoursProcedure
  extends StoredProcedure
{
  ...
  public UpdateDailyHoursProcedure()
  {
  }
  ...
  private void prepProc()
  {
    ...
    setFunction(false);
    setSql("Library_Web.dbo.uspUpdateDailyHours");
    //setSql("Library_Web_Test.dbo.uspUpdateDailyHours");
  ...
  private Map execute() 
  {
    ...
    input.put("Opens", ( ! opens.equals("-1") ? opens : null ) );
    input.put("Closes", ( !closes.equals("-1") ? closes : null ) );
