...
public class EditPeriodProcedure
  extends StoredProcedure
{
  ...
  private void prepProc()
  {
    ...
    setFunction( false );
    setSql("Library_Web.dbo.uspEditPeriod");
    //setSql( "Library_Web_Test.dbo.uspEditPeriod" );
